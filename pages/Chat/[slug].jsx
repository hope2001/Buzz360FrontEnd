...
function Chat() {
   ...
   return (
      <DashboardLayout>
         <div className="p:2 sm:p-6 justify-between flex flex-col h-3/5 bg-gray-700 rounded-lg">
            <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
               <div className="relative flex items-center space-x-4">
                  <div className="relative">
                     <span className="absolute text-green-600 right-0 bottom-0">
                  ...
                  <div className="flex flex-col leading-tight">
                     <div className="text-2xl mt-1 flex items-center">
                        <span className="text-gray-300 mr-3">Agent {router?.query.slug} </span>
                     </div>
                     {/* <span className="text-lg text-gray-200">Chatbot</span> */}
                  </div>
               </div>
         ...
         <button type="button" className="inline-flex items-center justify-center rounded-lg border h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6">
               ...
               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                     ...
                     <i className="bi bi-airplane-engines" title='Déployer'></i>
                  </button>
               </div>
            </div>
            <div id="messages" className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch h-screen">
               ...
               {converse?.map((item, index) => (item?.from == "IA" ?
                  <div key={index} className="chat-message">
                     <div className="flex items-end ">
                        <div className="flex flex-col space-y-2  max-w-x w-full mx-2 order-2 items-start ">
                           <div className=" w-full">
                              <span style={{ fontSize: "17px" }} className=" px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600">
                                 {item.message}
                              </span>
                           </div>
                        </div>
               ...
               {chatload &&
                  <div className="chat-message">
                     <div className="flex items-end justify-end">
                        <div style={{ fontSize: "20px" }} className="flex flex-col space-y-2  max-w-xs mx-2 order-1 items-end">
                           <div><span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">{querydata?.message}</span></div>
                        </div>
                        <img src="http://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" className="w-6 h-6 rounded-full order-2" />
                     </div>
                  </div>
               ...
               {chatload && <div className="chat-message">
                  <div className="flex items-end">
                     <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                        <div><span className="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600"> typing ...  </span></div>
                     </div>
                     <i className="bi bi-robot px-2 py-1 bg-gray-700  rounded-md align-middle mb-auto  text-white mx-2" style={{ fontSize: "20px" }}></i>
                  </div>
               </div>}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
               <div className="relative flex">
                  ...
                  <input type="text" {...register("query", { required: true })} placeholder="Write your message!" className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3" />
               ...
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6 text-gray-600">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                     ...
                     <button disabled={chatload} type="submit" className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
                        {/* <span className="font-bold">Send</span> */}
                        {chatload ? <Spinner /> : <span className="font-bold">Send</span>}
