                                                ...
                                                Install text-xl"></i>
                                                        ...
                                                        <MenuList>
                                                            <MenuGroup className="bg-purple-200 rounded-md" title='Options'>
                                                              ...
                                                              { isLoading? <span className="bg-purple-600 w-full p-2 text-white rounded-md flex justify-between"> <i className="bi bi-plugin mr-2"></i>  Traitement ... <Spinner
                                                                    thickness='4px'
                                                                    speed='0.65s'
                                                                    emptyColor='gray.200'
                                                                    color='blue.500'
                                                                    size='sm'
                                                                />  </span> :
                                                                <span className="bg-purple-600 w-full p-2 text-white rounded-md "> <i className="bi bi-plugin mr-2"></i>  Soumettre  </span> }
