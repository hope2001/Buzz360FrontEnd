        ...
        <i className="bi bi-plus-circle mx-1"> </i>Nouvel Agent
            ...
            <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                ...
                <div class="overflow-x-auto">
                    <div class="min-w-screen min-h-screenflex items-center justify-center bg-gray-100 font-sans overflow-hidden">
                        <div class="w-full lg:w-5/6 mx-auto">
                            <div class="bg-white shadow-md rounded my-6">
                                <table class="min-w-max w-full table-auto roundec-lg">
                                    <thead>
                                        <tr class="bg-gray-800 text-gray-100 uppercase text-sm leading-normal">
                                            <th class="py-3 px-6 text-left">Libelé</th>
                                            <th class="py-3 px-6 text-left">Description</th>
                                            <th class="py-3 px-6 text-center">Model</th>
                                            <th class="py-3 px-6 text-center">Status</th>
                                            <th class="py-3 px-6 text-center">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-gray-600 text-sm font-light">
                                        <tr className="w-full p-1 bg-blue-200 ">
                                            <td colspan="5" className="p-3 bg-gray-300 font-bold text-center w-full"> Aucun agent disponible.</td>
                                        ...
                                        {AgentList?.map((agent, index)=>(
                                            ...
                                            <td class="py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <span> Lorem ipsum ahoo j'ai juste besoin de texte
                                                    </span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <span class="bg-green-500 text-white py-2 px-3 rounded-md text-xs">Active</span>
                                            </td>
                                            <td class="py-3 px-6 text-center">
