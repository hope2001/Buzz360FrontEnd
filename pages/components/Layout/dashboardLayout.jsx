...
function DashLayout({children}) {
    ...
    return ( 
        ...
        <ChakraProvider>             
<main className="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-100">
        ...
        <div className="px-8 mx-auto max-w-7xl">
            ...
            <div className="flex items-center justify-between h-16">
                ...
                <div className="flex -mr-2 md:hidden">
                    <button onClick={()=> settoggleNav(!toggleNav)} className="text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none bg-gray-800">
