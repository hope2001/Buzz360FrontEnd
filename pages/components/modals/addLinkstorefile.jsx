...
// function AddDstoreLink({show, setShow}) {
...
//             <div className="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true">
//             <div className="flex justify-between p-2 ">
//                 <span className="bi bi-"> Ajout de Lien</span>
...
function AddDstoreLink({data,show, setShow}) {
    ...
    <div>
      ...
      {(show && data) && (
        <div className="fixed  z-100 overflow-y-auto top-0 w-full left-0">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="flex justify-between p-2 ">
                <span className="bi bi- text-lg"> Ajout une page à <strong className='text-bold text-purple-600' >{data?.label}</strong>  </span>
                <span  onClick={toggleModal} className="bi bi-x-circle-fill text-2xl cursor-pointer"></span>
            </div>
              {/* <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
      ...
      <div className="mb-4">
        ...
        <input className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
          type="text" id={'file'} multiple {...register("link", { required: true })}  />
